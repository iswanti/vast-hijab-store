                ...
                <div class="space-y-8">
                    ...
                    @if ($order->cancelled_at)
                        <div class="flex gap-4 relative">
                            ...
                            <div class="w-10 h-10 rounded-full bg-red-500 flex items-center justify-center text-white z-10">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">
                                    {{ $order->cancelled_at->format('d F Y H:i') }}
                                </p>
                            </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm p-6">
            ...
            @if ($order->status == 'Menunggu Konfirmasi')
                <form action="{{ route('orders.confirm', $order->id) }}" method="POST">
                    ...
                    <button class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl font-semibold">
            ...
            @if ($order->status == 'Diproses')
                <form action="{{ route('orders.kirim', $order->id) }}" method="POST" class="space-y-4">

                    @csrf
                    @method('PUT')

                    <input type="text" name="resi" required placeholder="Masukkan nomor resi pengiriman..."
                        class="w-full border rounded-xl px-4 py-3">

                    <button class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold">
